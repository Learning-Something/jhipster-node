...
export class Config {
  ...
  'server.port' = '8081';
  'jhipster.clientApp.name' = 'node_api';
  ...
  'jhipster.mail.from' = 'node_api@localhost';
  'jhipster.swagger.default-include-pattern' = '/api/.*';
  'jhipster.swagger.title' = 'node_api API';
  'jhipster.swagger.description' = 'node_api API documentation';
  ...
  'eureka.instance.appname' = 'node_api';
  'eureka.instance.instanceId' = 'node_api:${random.value}';
